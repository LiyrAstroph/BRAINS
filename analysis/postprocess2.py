...
def postprocess(ndim):
  ...
  levels_orig = np.genfromtxt("../data/levels"+str_dim+".txt", comments='#', dtype=float, skip_footer=1)
  sample_info = np.genfromtxt("../data/sample_info"+str_dim+".txt", comments='#', dtype=float, skip_footer=1)
  sample = np.atleast_2d(np.genfromtxt("../data/sample"+str_dim+".txt", comments='#', skip_footer=1, dtype=float))
