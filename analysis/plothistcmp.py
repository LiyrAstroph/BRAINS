...
ax1.plot(d[:, 4]*2, d[:, 8]/np.log(10.0)+6.0, ls='none', marker='.', markersize=3)
...
ax2.plot(90.0-d[:, 3], d[:, 8]/np.log(10.0)+6.0, ls='none', marker='.', markersize=3)
...
ax4.plot(d[:, 4]*2, 90.0-d[:, 3], ls='none', marker='.', markersize=3)
...
ax5.hist(90.0-d[:, 3], bins = 10, normed=True)
...
ax6.hist(2.0*d[:, 4], bins = 10, normed=True)
...
ax7.hist(np.exp(d[:, 0]), bins = 10, range=(0, 8), normed=True)
